  ...
  .factory('pwdService', ["$http", "$location", "$rootScope", function($http, $location, $rootScope) {
    var p = {
      ...
      assignSession: function() {
       return $http.post('https://beta-hybrid.play-with-docker.com/workshops/97b53120-a585-45d4-bce5-e0cc701fb28f/session', {}, {headers: {'Accept': 'application/json'}}).then(function(response) {
